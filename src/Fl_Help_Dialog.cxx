...
const char* Fl::txt_show_previous_help_page = "Show the previous help page.";
const char* Fl::txt_make_the_help_text_smaller = "Make the help text smaller.";
const char* Fl::txt_show_next_help_page = "Show the next help page.";
const char* Fl::txt_make_the_help_text_larger = "Make the help text larger.";
const char* Fl::txt_help_dialog = "Help Dialog";
const char* Fl::txt_at_search = "@search";
const char* Fl::txt_find_text = "find text in document";
...
Fl_Help_Dialog::Fl_Help_Dialog() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = window_ = new Fl_Double_Window(530, 385, Fl::txt_help_dialog);
    w = o;
    ...
    { Fl_Group* o = new Fl_Group(10, 350, 265, 25);
      ...
      { Fl_Input* o = find_ = new Fl_Input(35, 352, 238, 21, Fl::txt_at_search);
        o->tooltip(Fl::txt_find_text);
        o->box(FL_FLAT_BOX);
        o->labelsize(13);
