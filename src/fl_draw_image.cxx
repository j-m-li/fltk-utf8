...
const char* Fl::txt_cannot_do_scanline = "Can't do scanline_pad of %d";
const char* Fl::txt_cannot_bits_per_pixel="Can't do %d bits_per_pixel colormap";
const char* Fl::txt_cannot_24bit = "Can't do arbitrary 24bit color";
const char* Fl::txt_cannot_do_bits_per_pixel = "Can't do %d bits_per_pixel";
...
//i.bitmap_pad = 8;
  ...
  if (pfv->scanline_pad & 7 || (n&(n-1)))
    Fl::fatal(Fl::txt_cannot_do_scanline,pfv->scanline_pad);
...
#  if USE_COLORMAP
  ...
  if (!fl_visual->red_mask)
    Fl::fatal(Fl::txt_cannot_bits_per_pixel,xi.bits_per_pixel);
#  endif
...
#  endif
  ...
  default:
    Fl::fatal(Fl::txt_cannot_do_bits_per_pixel,xi.bits_per_pixel);
  }
