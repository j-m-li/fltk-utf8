...
const char *Fl::txt_choose_file = "Choose File";
const char *Fl::txt_show = "Show";
const char *Fl::txt_favorites = "Favorites";
const char *Fl::txt_preview = "Preview";
const char *Fl::txt_file_name = "Filename:";
const char *Fl::txt_manage_favorites = "Manage Favorites";
...
Fl_File_Chooser::Fl_File_Chooser(const char *d, const char *p, int t, const char *title) {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = window = new Fl_Double_Window(490, 380, Fl::txt_choose_file);
    w = o;
    o->callback((Fl_Callback*)cb_window, (void*)(this));
    { Fl_Group* o = new Fl_Group(65, 10, 415, 25);
      { Fl_Choice* o = showChoice = new Fl_Choice(65, 10, 215, 25, Fl::txt_show);
        o->down_box(FL_BORDER_BOX);
        o->callback((Fl_Callback*)cb_showChoice);
        Fl_Group::current()->resizable(o);
        showChoice->label(show_label);
      }
      { Fl_Menu_Button* o = favoritesButton = new Fl_Menu_Button(290, 10, 155, 25, Fl::txt_favorites);
        o->down_box(FL_BORDER_BOX);
    ...
    { Fl_Group* o = new Fl_Group(0, 275, 480, 95);
      { Fl_Group* o = new Fl_Group(10, 275, 470, 20);
        { Fl_Check_Button* o = previewButton = new Fl_Check_Button(10, 275, 170, 20, Fl::txt_preview);
      ...
      { Fl_Box* o = new Fl_Box(10, 310, 105, 25, Fl::txt_file_name);
        o->align(FL_ALIGN_RIGHT|FL_ALIGN_INSIDE);
        o->label(filename_label);
      }
      { Fl_Group* o = new Fl_Group(10, 345, 470, 25);
        { Fl_Return_Button* o = okButton = new Fl_Return_Button(300, 345, 85, 25, Fl::txt_ok);
          o->callback((Fl_Callback*)cb_okButton);
          okButton->label(Fl::txt_ok);
        }
        { Fl_Button* o = new Fl_Button(395, 345, 85, 25, Fl::txt_cancel);
          o->callback((Fl_Callback*)cb_Cancel);
          o->label(Fl::txt_cancel);
        }
  ...
  { Fl_Double_Window* o = favWindow = new Fl_Double_Window(355, 150, Fl::txt_manage_favorites);
    w = o;
    ...
    { Fl_Button* o = favCancelButton = new Fl_Button(270, 115, 75, 25, Fl::txt_cancel);
      o->callback((Fl_Callback*)cb_favCancelButton);
      favCancelButton->label(Fl::txt_cancel);
    }
    { Fl_Return_Button* o = favOkButton = new Fl_Return_Button(185, 115, 75, 25, Fl::txt_ok);
      o->callback((Fl_Callback*)cb_favOkButton);
      favOkButton->label(Fl::txt_ok);
    }
